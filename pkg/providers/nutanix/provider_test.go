...
/*
func testNutanixProviderWithProviderKubectl(t *testing.T, _ Client, kubectl *mocknutanix.MockProviderKubectlClient, certValidator crypto.TlsValidator, httpClient *http.Client, writer filewriter.FileWriter) *Provider {
